...
#conv_II=Conv1D(filters=16,kernel_size=16,strides=1,padding='same')(bat_II)
lstm_II=LSTM(128, return_sequences=True)(bat_II)
attention_II=AttentionWithContext()(lstm_II)
flat_II=Flatten()(attention_II)

in_V1 = Input(shape=(seq, feature),name="input_2")
mask_V1=Masking(mask_value=-999.0)(in_V1)
bat_V1=BatchNormalization()(mask_V1)
#lstm_V1=LSTM(120, return_sequences=True)(bat_V1)
#conv_V1=Conv1D(filters=16,kernel_size=16,strides=1,padding='same')(bat_V1)
lstm_V1=LSTM(128, return_sequences=True)(bat_V1)
attention_V1=AttentionWithContext()(lstm_V1)
flat_V1=Flatten()(attention_V1)
